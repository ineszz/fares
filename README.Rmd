...
<!-- badges: start -->
[![Travis build status](https://travis-ci.com/ineszz/fars.svg?branch=master)](https://travis-ci.com/ineszz/fars)
<!-- badges: end -->
...
You can install the released version of fars2 from [CRAN](https://CRAN.R-project.org) with:
